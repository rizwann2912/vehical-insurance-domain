...
from src.utils.main_utils import read_yaml_file, drop_columns
...
class DataValidation:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            train_df = drop_columns(train_df,cols=self._schema_config["drop_columns"])
            test_df = drop_columns(test_df,cols=self._schema_config["drop_columns"])
            logging.info(f'train_df.head()={train_df.head()}')
            ...
            data_validation_artifact = DataValidationArtifact(
                ...
                validation_report_file_path=self.data_validation_config.data_validation_file_report_path
            )

            # Ensure the directory for validation_report_file_path exists
            report_dir = os.path.dirname(self.data_validation_config.data_validation_file_report_path)
            ...
            with open(self.data_validation_config.data_validation_file_report_path, "w") as report_file:
